# Archived Phases — Space & Science Fiction App

> Completed and declined phase brainstorms + as-built notes, moved out of [`future_phases.md`](future_phases.md) on **2026-06-20** to keep that file lean. This is the verbatim record — provenance, research findings, divisor derivations, and design decisions not all captured in `docs/`. For **shipped behavior** see `docs/`; for **build-ready specs** see the `PHASE_*_PLAN.md` files. **Phase G has no plan file — this archive is its canonical detailed record.**
>
> Forward-looking work (the Phase Q / R / S candidates) stays in [`future_phases.md`](future_phases.md).

## Contents

- [Phase G — Interactive Data Search & Filtering ✅ IMPLEMENTED (2026-06-10)](#phase-g--interactive-data-search--filtering--implemented-2026-06-10)
- [Phase H — Worldbuilding Calculators ✅ IMPLEMENTED (2026-06-11)](#phase-h--worldbuilding-calculators--implemented-2026-06-11)
- [Phase I — Multi-System / Route Planning ✅ IMPLEMENTED (2026-06-12)](#phase-i--multi-system--route-planning--implemented-2026-06-12)
- [Phase J — User Preferences & Settings ❌ DECLINED (2026-06-14)](#phase-j--user-preferences--settings--declined-2026-06-14)
- [Phase K — Honorverse Expansion ✅ IMPLEMENTED (2026-06-13)](#phase-k--honorverse-expansion--implemented-2026-06-13)
- [Phase L — Exoplanet Comparison Dashboard](#phase-l--exoplanet-comparison-dashboard)
- [Phase M — GCNS Interactive Surfacing ✅ IMPLEMENTED (2026-06-11)](#phase-m--gcns-interactive-surfacing--implemented-2026-06-11)
- [Phase N — query.py Integration Expansion ✅ IMPLEMENTED (2026-06-12)](#phase-n--querypy-integration-expansion--implemented-2026-06-12)
- [Phase O — Visualization Expansion](#phase-o--visualization-expansion)
- [Phase P — Snow Lines & Alternative-Solvent Habitable Zones (grounded + extended)](#phase-p--snow-lines--alternative-solvent-habitable-zones-grounded--extended)
- [Implementation Priority Recommendation (historical)](#implementation-priority-recommendation-historical)
...
## Implementation Priority Recommendation (historical)
