...
> **Historical planning doc — completed.** This records the original GCNS feature request, now fully implemented. See `docs/star-databases.md` (opt 58 ingest) and `docs/integration.md` (GCNS subcommand contract) for the as-built details.
