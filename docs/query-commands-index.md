...
**Total: 179 subcommands** (distinct `query.py` `add_parser` names — 182 `add_parser` calls including 3 aliases; all 179
are documented in `docs/integration.md`).
