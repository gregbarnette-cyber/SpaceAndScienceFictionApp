...
> **OEC System View — star-first master/detail (built 2026-08-02, `OEC_SYSTEM_VIEW_PLAN.md`).**
...
change, 2026-07-31 — moved out of `distance_stars.py`, which **re-exports all of them** (that
