...
# ── Viz helpers shared by opts 3, 4, 5 (extracted to gui/panels/diagram_tabs.py) ──
# These stateless tab-builders live in a neutral shared module so OecPanel (opt 7) can
# reuse them without importing another panel's privates. Imported here by name so the
# call sites below are unchanged.
from gui.panels.diagram_tabs import (
    _make_hz_tab, _make_hz_tab_exocat, _hyper_au_for, _make_orbits_tab,
    _make_mass_radius_tab, _make_transit_tab, _make_size_tab,
)
